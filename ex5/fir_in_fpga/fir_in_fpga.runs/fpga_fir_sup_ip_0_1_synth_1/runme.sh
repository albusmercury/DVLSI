...
HD_PWD='C:/Xilinx/Vivado/2018.2/layouts/workspace/5th_exercise/fir_in_fpga/fir_in_fpga.runs/fpga_fir_sup_ip_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga_fir_sup_ip_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fpga_fir_sup_ip_0_1.tcl
