...
HD_PWD='C:/Xilinx/Vivado/2018.2/layouts/workspace/6th_exercise/6th_exercise.runs/debayering_fifo_generator_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log debayering_fifo_generator_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source debayering_fifo_generator_0_2.tcl
