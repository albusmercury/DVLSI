...
HD_PWD='C:/Xilinx/Vivado/2018.2/layouts/workspace/6th_exercise/6th_exercise.runs/debayering_fsm_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log debayering_fsm_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source debayering_fsm_0_0.tcl
