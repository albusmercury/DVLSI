...
HD_PWD='C:/Xilinx/Vivado/2018.2/layouts/workspace/3rd_exercise/exc3/exc3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pipelined_4bit_mul.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pipelined_4bit_mul.tcl
